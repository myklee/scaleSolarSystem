$(function() {
		...
		$('.bgRuler').hover(function(){
                ...
                showInfo($this);//$(this).find('.infoSmall').css('display','block').animate({opacity: '.5'}, {duration:300, queue:false});
                $this.animate({opacity: '1'}, {duration:100, queue:false});
        }, function() {
                var $this = $(this);
                $this.find('p').animate({left: '-25', top:'0', fontSize: '.7em'}, {duration:100, queue:false});
                hideInfo($this);//$this.find('.infoSmall').css('display','none').animate({opacity: '0'}, {duration:300, queue:false});
